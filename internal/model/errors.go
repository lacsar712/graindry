...
var (
	...
	ErrMoistureDrift   = errors.New("graindry: moisture drift exceeded")
	ErrHeatOvertemp    = errors.New("graindry: heat overtemperature")
	ErrGradientHold    = errors.New("graindry: gradient hold not satisfied")
